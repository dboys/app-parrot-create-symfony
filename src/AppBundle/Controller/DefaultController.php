...
class DefaultController extends Controller
{
     ...
     * @Method({"POST"})
     */
    public function libContent(Request $request, LoggerInterface $logger)
    {
        ...
        $response = new Response($lib_content);
     ...
     * @Method({"POST"})
     */
    public function hllContent(Request $request, LoggerInterface $logger)
    {
        $data = $request->request->all();
        ...
        $response = new Response($hll_content);
